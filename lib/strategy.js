...
/**
 * Retrieve user profile from GoCollab.
 *
 * This function constructs a normalized profile, with the following properties:
 *
 *   - `provider`         always set to `gocollab`
 *   - `id`               the user's GoCollab ID
 *   - `username`         the user's GoCollab username
 *   - `displayName`      the user's full name
 *   - `profileUrl`       the URL of the profile for the user on GoCollab
